...
<div class="container theme-showcase" role="main">
	<div class="col-md-10 white-bloc centred">
		...
		<div class="form-group multi-input"> 
			<label id="actualSurname" for="changeSurname" class="col-sm-3 control-label"><?php echo $user['surname']; ?></label>
			<div class="col-sm-4">
		...
		<div class="clearer"></div>
		<div class="form-group multi-input"> 
			<label id="actualRegion" for="changeRegion" class="col-sm-3 control-label"><?php echo $user['region']; ?></label>
			<div class="col-sm-4">
